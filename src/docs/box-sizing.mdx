...
export const description = "Các tiện ích để kiểm soát cách trình duyệt tính toán tổng kích thước của một phần tử.";
...
Điều này có nghĩa là một phần tử 100px &times; 100px với border 2px và padding 4px ở tất cả các cạnh sẽ được hiển thị là 100px &times; 100px, với vùng nội dung bên trong là 88px &times; 88px:
...
Tailwind đặt đây làm mặc định cho tất cả các phần tử trong [preflight base styles](/docs/preflight) của chúng tôi.
...
Điều này có nghĩa là một phần tử 100px &times; 100px với border 2px và padding 4px ở tất cả các cạnh sẽ thực sự được hiển thị là 112px &times; 112px, với vùng nội dung bên trong là 100px &times; 100px:
