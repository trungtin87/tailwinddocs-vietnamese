...
export const description =
  "Các utility để kiểm soát cách hình nền của một phần tử hòa trộn với màu nền của nó.";
...
Sử dụng các utility như `bg-blend-difference` và `bg-blend-saturation` để kiểm soát cách hình nền và màu của một phần tử được hòa trộn:
