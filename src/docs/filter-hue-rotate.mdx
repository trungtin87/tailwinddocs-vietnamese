...
export const description = "Các tiện ích để áp dụng bộ lọc hue-rotate cho một phần tử.";
...
Sử dụng các tiện ích như `hue-rotate-90` và `hue-rotate-180` để xoay màu (hue) của một phần tử theo độ:
...
Sử dụng các tiện ích như `-hue-rotate-15` và `-hue-rotate-45` để đặt giá trị xoay màu âm:
