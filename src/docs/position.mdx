...
export const description = "Các tiện ích để kiểm soát cách một phần tử được định vị trong tài liệu.";
...
Với các phần tử được định vị tĩnh, mọi [offset](/docs/top-right-bottom-left) sẽ bị bỏ qua và phần tử sẽ không đóng vai trò là tham chiếu vị trí cho các phần tử con được định vị tuyệt đối.
...
Với các phần tử được định vị tương đối, mọi [offset](/docs/top-right-bottom-left) được tính toán tương đối so với vị trí bình thường của phần tử và phần tử sẽ đóng vai trò là tham chiếu vị trí cho các phần tử con được định vị tuyệt đối.

### Định vị tuyệt đối các phần tử

Sử dụng tiện ích `absolute` để định vị một phần tử _bên ngoài_ luồng bình thường của tài liệu, khiến các phần tử lân cận hoạt động như thể phần tử đó không tồn tại:
...
Với các phần tử được định vị tuyệt đối, mọi [offset](/docs/top-right-bottom-left) được tính toán tương đối so với phần tử cha gần nhất có vị trí khác `static`, và phần tử sẽ đóng vai trò là tham chiếu vị trí cho các phần tử con được định vị tuyệt đối khác.
...
Với các phần tử được định vị cố định, mọi [offset](/docs/top-right-bottom-left) được tính toán tương đối so với khung nhìn (viewport) và phần tử sẽ đóng vai trò là tham chiếu vị trí cho các phần tử con được định vị tuyệt đối:
...
Với các phần tử được định vị dính, mọi [offset](/docs/top-right-bottom-left) được tính toán tương đối so với vị trí bình thường của phần tử và phần tử sẽ đóng vai trò là tham chiếu vị trí cho các phần tử con được định vị tuyệt đối.
