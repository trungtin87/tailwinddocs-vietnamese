...
export const description = "Các tiện ích để kiểm soát kích thước ban đầu của các flex item.";
...
Sử dụng các tiện ích `basis-<number>` như `basis-64` và `basis-128` để đặt kích thước ban đầu của các flex item dựa trên spacing scale:
...
Sử dụng các tiện ích như `basis-xs` và `basis-sm` để đặt kích thước ban đầu của các flex item dựa trên container scale:
...
Sử dụng các tiện ích `basis-<fraction>` như `basis-1/2` và `basis-2/3` để đặt kích thước ban đầu của các flex item:
