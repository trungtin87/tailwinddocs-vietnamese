...
export const description = "Các tiện ích để áp dụng bộ lọc sepia cho một phần tử.";
...
Sử dụng các tiện ích như `sepia` và `sepia-50` để kiểm soát hiệu ứng sepia được áp dụng cho một phần tử:
