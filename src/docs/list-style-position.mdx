...
export const description = "Các tiện ích để kiểm soát vị trí của dấu đầu dòng và số trong danh sách.";
...
Sử dụng các tiện ích như `list-inside` và `list-outside` để kiểm soát vị trí của các dấu đầu dòng và thụt lề văn bản trong danh sách:
