...
export const description = "Các utility để kiểm soát việc bạn có thể bỏ qua các vị trí snap có thể hay không.";
...
### Buộc dừng tại vị trí snap

Sử dụng utility `snap-always` cùng với utility [snap-mandatory](/docs/scroll-snap-type#mandatory-scroll-snapping) để buộc snap container luôn dừng tại một phần tử trước khi người dùng có thể tiếp tục cuộn đến item tiếp theo:
...
### Bỏ qua dừng tại vị trí snap

Sử dụng utility `snap-normal` để cho phép snap container bỏ qua các vị trí scroll snap có thể:
