...
export const description = "Các tiện ích để kiểm soát kiểu dấu đầu dòng của danh sách.";
...
Sử dụng các tiện ích như `list-disc` và `list-decimal` để kiểm soát kiểu của các dấu đầu dòng trong danh sách:
