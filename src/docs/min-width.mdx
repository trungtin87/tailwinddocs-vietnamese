...
export const description = "Các tiện ích để đặt chiều rộng tối thiểu của một phần tử.";
...
Sử dụng các tiện ích `min-w-<number>` như `min-w-24` và `min-w-64` để đặt một phần tử có chiều rộng tối thiểu cố định dựa trên spacing scale:
...
Sử dụng các tiện ích `min-w-full` hoặc `min-w-<fraction>` như `min-w-1/2` và `min-w-2/5` để cung cấp cho một phần tử chiều rộng tối thiểu dựa trên phần trăm:
...
### Sử dụng container scale

Sử dụng các tiện ích như `min-w-sm` và `min-w-xl` để đặt một phần tử có chiều rộng tối thiểu cố định dựa trên container scale:
