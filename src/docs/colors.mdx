...
export const title = "Màu sắc";
export const description = "Sử dụng và tùy chỉnh bảng màu trong các dự án Tailwind CSS.";

Tailwind CSS bao gồm một bảng màu phong phú, đẹp mắt ngay lập tức, được chế tác cẩn thận bởi các nhà thiết kế chuyên nghiệp và phù hợp với nhiều phong cách thiết kế khác nhau.
...
Mỗi màu trong bảng màu mặc định bao gồm 11 bước, với 50 là nhạt nhất và 950 là đậm nhất:
...
Toàn bộ bảng màu có sẵn trên tất cả các utility liên quan đến màu sắc, bao gồm những thứ như [màu nền](/docs/background-color), [màu border](/docs/border-color), [fill](/docs/fill), [màu caret](/docs/caret-color), và nhiều thứ khác.

## Làm việc với màu sắc

### Sử dụng các utility màu sắc

Sử dụng các utility màu sắc như `bg-white`, `border-pink-300`, và `text-gray-950` để thiết lập các thuộc tính màu khác nhau của các phần tử trong thiết kế của bạn:
...
Dưới đây là danh sách đầy đủ các utility sử dụng bảng màu của bạn:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Thiết lập <a href="/docs/background-color">màu nền</a> của một phần tử
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/text-color">màu văn bản</a> của một phần tử
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/text-decoration-color">màu trang trí văn bản</a> của một phần tử
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/border-color">màu border</a> của một phần tử
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/outline-color">màu outline</a> của một phần tử
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập màu của <a href="/docs/box-shadow#setting-the-shadow-color">box shadow</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập màu của <a href="/docs/box-shadow#setting-the-inset-shadow-color">inset box shadow</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập màu của <a href="/docs/box-shadow#setting-the-ring-color">ring shadow</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập màu của <a href="/docs/box-shadow#setting-the-inset-ring-color">inset ring shadow</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/accent-color">màu accent</a> của các form control
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/caret-color">màu caret</a> trong các form control
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/fill">màu fill</a> của các phần tử SVG
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Thiết lập <a href="/docs/stroke">màu stroke</a> của các phần tử SVG
      </td>
    </tr>
  </tbody>
</table>
...
### Điều chỉnh độ mờ (opacity)

Bạn có thể điều chỉnh độ mờ của một màu bằng cách sử dụng cú pháp như `bg-black/75`, trong đó `75` thiết lập kênh alpha của màu thành 75%:
...
Cú pháp này cũng hỗ trợ các giá trị tùy ý và shorthand biến CSS:
...
### Nhắm mục tiêu chế độ tối (dark mode)

Sử dụng variant `dark` để viết các class như `dark:bg-gray-800` chỉ áp dụng màu khi chế độ tối đang hoạt động:
...
Tìm hiểu thêm về cách styling cho chế độ tối trong [tài liệu chế độ tối](/docs/dark-mode).

### Tham chiếu trong CSS

Các màu được hiển thị dưới dạng các biến CSS trong namespace `--color-*`, vì vậy bạn có thể tham chiếu chúng trong CSS bằng các biến như `--color-blue-500` và `--color-pink-700`:
...
Bạn cũng có thể sử dụng chúng làm [giá trị tùy ý]() trong các utility class:
...
Để nhanh chóng điều chỉnh độ mờ của một màu khi tham chiếu nó như một biến trong CSS, Tailwind bao gồm một hàm đặc biệt <code>--alpha()</code>:
...
Sử dụng `@theme` để thêm các màu tùy chỉnh vào dự án của bạn dưới namespace theme `--color-*`:
...
Bây giờ các utility như `bg-midnight`, `text-tahiti`, và `fill-bermuda` sẽ có sẵn trong dự án của bạn cùng với các màu mặc định.

Tìm hiểu thêm về các biến theme trong [tài liệu biến theme](/docs/theme).

### Ghi đè các màu mặc định

Ghi đè bất kỳ màu mặc định nào bằng cách định nghĩa các biến theme mới có cùng tên:
...
### Vô hiệu hóa các màu mặc định

Vô hiệu hóa bất kỳ màu mặc định nào bằng cách đặt namespace theme cho màu đó thành `initial`:
...
Điều này đặc biệt hữu ích để loại bỏ các biến CSS tương ứng khỏi output của bạn cho các màu bạn không có ý định sử dụng.

### Sử dụng bảng màu tùy chỉnh

Sử dụng `--color-*: initial` để vô hiệu hóa hoàn toàn tất cả các màu mặc định và định nghĩa bảng màu tùy chỉnh của riêng bạn:
...
Sử dụng `@theme inline` khi định nghĩa các màu tham chiếu đến các màu khác:
...
Tìm hiểu thêm trong tài liệu theme về [tham chiếu các biến khác](/docs/theme#referencing-other-variables).

## Tham chiếu bảng màu mặc định

Dưới đây là danh sách đầy đủ các màu mặc định và giá trị của chúng để tham khảo:
