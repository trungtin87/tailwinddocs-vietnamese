...
export const description = "Các tiện ích để kiểm soát căn chỉnh scroll snap của một phần tử.";
...
Sử dụng tiện ích `snap-center` để snap một phần tử vào giữa của nó khi được cuộn bên trong một snap container:
...
Sử dụng tiện ích `snap-start` để snap một phần tử vào đầu của nó khi được cuộn bên trong một snap container:
...
Sử dụng tiện ích `snap-end` để snap một phần tử vào cuối của nó khi được cuộn bên trong một snap container:
