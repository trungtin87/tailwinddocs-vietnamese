...
export const description = "Các tiện ích để áp dụng bộ lọc contrast cho một phần tử.";
...
Sử dụng các tiện ích như `contrast-50` và `contrast-100` để kiểm soát độ tương phản của một phần tử:
