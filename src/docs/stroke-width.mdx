...
export const description = "Các tiện ích để tạo kiểu cho độ rộng nét vẽ của các phần tử SVG.";
...
Sử dụng các tiện ích `stroke-<number>` như `stroke-1` và `stroke-2` để đặt độ rộng nét vẽ của SVG:
