...
export const description = "Các tiện ích để áp dụng bộ lọc saturation cho một phần tử.";
...
Sử dụng các tiện ích như `saturate-50` và `saturate-100` để kiểm soát độ bão hòa của một phần tử:
