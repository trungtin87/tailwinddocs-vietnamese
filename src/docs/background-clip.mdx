...
export const description = "Các tiện ích để kiểm soát hộp giới hạn của nền của một phần tử.";
...
Sử dụng các tiện ích `bg-clip-border`, `bg-clip-padding`, và `bg-clip-content` để kiểm soát hộp giới hạn của nền của một phần tử:
...
Sử dụng tiện ích `bg-clip-text` để cắt nền của một phần tử để khớp với hình dạng của văn bản:
