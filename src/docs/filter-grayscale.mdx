...
export const description = "Các tiện ích để áp dụng bộ lọc grayscale cho một phần tử.";
...
Sử dụng các tiện ích như `grayscale` và `grayscale-75` để kiểm soát lượng hiệu ứng grayscale được áp dụng cho một phần tử:
