...
export const description = "Các tiện ích để tạo kiểu cho stroke của các phần tử SVG.";
...
Sử dụng các tiện ích như `stroke-indigo-500` và `stroke-lime-600` để thay đổi màu stroke của một SVG:
...
<Figure hint="Di chuột qua nút để thấy màu stroke thay đổi">
