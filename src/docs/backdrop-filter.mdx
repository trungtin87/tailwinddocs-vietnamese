...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-blur-xs` và `backdrop-grayscale` để áp dụng các bộ lọc cho backdrop của một phần tử:
...
Bạn có thể kết hợp các tiện ích bộ lọc backdrop sau: [blur](/docs/backdrop-filter-blur), [brightness](/docs/backdrop-filter-brightness), [contrast](/docs/backdrop-filter-contrast), [grayscale](/docs/backdrop-filter-grayscale), [hue-rotate](/docs/backdrop-filter-hue-rotate), [invert](/docs/backdrop-filter-invert), [opacity](/docs/backdrop-filter-opacity), [saturate](/docs/backdrop-filter-saturate), và [sepia](/docs/backdrop-filter-sepia).

### Loại bỏ bộ lọc

Sử dụng tiện ích `backdrop-filter-none` để loại bỏ tất cả các bộ lọc backdrop được áp dụng cho một phần tử:
