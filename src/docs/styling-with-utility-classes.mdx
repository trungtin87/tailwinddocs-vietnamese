...
Dưới đây là một class `btn-primary` có thể trông như thế nào, sử dụng [các biến theme](/docs/theme#with-custom-css) để giữ cho thiết kế nhất quán:
...
Nếu bạn đang thêm Tailwind vào một dự án có CSS phức tạp hiện có với các quy tắc độ đặc hiệu cao, bạn có thể sử dụng cờ `important` khi nhập Tailwind để đánh dấu _tất cả_ các tiện ích là `!important`:
