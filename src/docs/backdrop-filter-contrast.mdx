...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop contrast cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-contrast-50` và `backdrop-contrast-100` để kiểm soát độ tương phản backdrop của một phần tử:
