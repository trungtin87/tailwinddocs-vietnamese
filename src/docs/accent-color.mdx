...
export const description = "Các tiện ích để kiểm soát màu nhấn của một form control.";
...
Sử dụng các tiện ích như `accent-rose-500` và `accent-lime-600` để thay đổi màu nhấn của một phần tử:
