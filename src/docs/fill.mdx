...
export const description = "Các tiện ích để tạo kiểu cho fill của các phần tử SVG.";
...
Sử dụng các tiện ích như `fill-indigo-500` và `fill-lime-600` để thay đổi màu fill của một SVG:
...
Điều này có thể hữu ích để tạo kiểu cho các bộ icon như [Heroicons](https://heroicons.com).

### Sử dụng màu hiện tại

Sử dụng tiện ích `fill-current` để đặt màu fill thành màu văn bản hiện tại:

<Figure hint="Di chuột qua nút để thấy màu fill thay đổi">
