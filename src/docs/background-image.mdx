...
export const description = "Các utility để kiểm soát hình nền của một phần tử.";
...
Sử dụng cú pháp `bg-[<value>]` để thiết lập hình nền của một phần tử:
...
### Thêm gradient tuyến tính

Sử dụng các utility như `bg-linear-to-r` và `bg-linear-<angle>` với [các utility điểm dừng màu](#setting-gradient-color-stops) để thêm gradient tuyến tính vào một phần tử:
...
### Thêm gradient xuyên tâm

Sử dụng các utility `bg-radial` và `bg-radial-[<position>]` với [các utility điểm dừng màu](#setting-gradient-color-stops) để thêm gradient xuyên tâm vào một phần tử:
...
### Thêm gradient hình nón

Sử dụng các utility `bg-conic` và `bg-conic-<angle>` với [các utility điểm dừng màu](#setting-gradient-color-stops) để thêm gradient hình nón vào một phần tử:
...
### Thiết lập điểm dừng màu gradient

Sử dụng các utility như `from-indigo-500`, `via-purple-500`, và `to-pink-500` để thiết lập màu của các điểm dừng gradient:
...
### Thiết lập vị trí điểm dừng gradient

Sử dụng các utility như `from-10%`, `via-30%`, và `to-90%` để thiết lập vị trí chính xác hơn cho các điểm dừng màu gradient:
...
### Thay đổi chế độ nội suy

Sử dụng modifier nội suy để kiểm soát chế độ nội suy của một gradient:
...
Theo mặc định, các gradient được nội suy trong không gian màu `oklab`.

### Xóa hình nền

Sử dụng utility `bg-none` để xóa hình nền hiện có khỏi một phần tử:
