...
export const description = "Các utility để kiểm soát độ rộng của border của một phần tử.";
...
Sử dụng các utility `border` hoặc `border-<number>` như `border-2` và `border-4` để thiết lập độ rộng border cho tất cả các cạnh của một phần tử:
...
Sử dụng các utility như `border-r` và `border-t-4` để thiết lập độ rộng border cho một cạnh của một phần tử:
...
Sử dụng các utility như `border-x` và `border-y-4` để thiết lập độ rộng border trên hai cạnh của một phần tử cùng một lúc:
...
Sử dụng các utility như `border-s` và `border-e-4` để thiết lập các [thuộc tính logic](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts) `border-inline-start-width` và `border-inline-end-width`, ánh xạ tới border trái hoặc phải dựa trên hướng văn bản:
...
Sử dụng các utility như `divide-x` và `divide-y-4` để thêm border giữa các phần tử con:
