...
export const description = "Các tiện ích để kiểm soát cách một phần tử nên hòa trộn với nền.";
...
Sử dụng các tiện ích như `mix-blend-overlay` và `mix-blend-soft-light` để kiểm soát cách nội dung của một phần tử và nền được hòa trộn với nội dung khác trong cùng một stacking context:
...
Sử dụng tiện ích `isolate` trên phần tử cha để tạo một stacking context mới và ngăn chặn việc hòa trộn với nội dung phía sau nó:
