...
export const description = "Các tiện ích để kiểm soát kiểu của text decoration.";
...
Sử dụng các tiện ích như `decoration-dotted` và `decoration-dashed` để thay đổi kiểu của [text decoration](/docs/text-decoration-line) của một phần tử:
