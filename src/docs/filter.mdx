...
export const description = "Các tiện ích để áp dụng bộ lọc cho một phần tử.";
...
Bạn có thể kết hợp các tiện ích bộ lọc sau: [blur](/docs/filter-blur), [brightness](/docs/filter-brightness), [contrast](/docs/filter-contrast), [drop-shadow](/docs/filter-drop-shadow), [grayscale](/docs/filter-grayscale), [hue-rotate](/docs/filter-hue-rotate), [invert](/docs/filter-invert), [saturate](/docs/filter-saturate), và [sepia](/docs/filter-sepia).
