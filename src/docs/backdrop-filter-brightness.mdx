...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop brightness cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-brightness-50` và `backdrop-brightness-100` để kiểm soát độ sáng backdrop của một phần tử:
