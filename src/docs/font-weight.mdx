...
export const description = "Các tiện ích để kiểm soát độ đậm phông chữ của một phần tử.";
...
Sử dụng các tiện ích như `font-thin` và `font-bold` để đặt độ đậm phông chữ của một phần tử:
