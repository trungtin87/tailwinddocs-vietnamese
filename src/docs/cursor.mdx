...
export const description = "Các tiện ích để kiểm soát kiểu con trỏ khi di chuột qua một phần tử.";
...
Sử dụng các tiện ích như `cursor-pointer` và `cursor-grab` để kiểm soát con trỏ nào được hiển thị khi di chuột qua một phần tử:

<Figure hint="Di chuột qua từng nút để thấy con trỏ thay đổi">
