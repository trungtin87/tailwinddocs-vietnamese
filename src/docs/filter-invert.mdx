...
export const description = "Các tiện ích để áp dụng bộ lọc invert cho một phần tử.";
...
Sử dụng các tiện ích như `invert` và `invert-20` để kiểm soát việc đảo ngược màu của một phần tử:
