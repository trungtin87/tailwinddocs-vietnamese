...
export const title = "Biến theme";
export const description = "Sử dụng các lớp tiện ích như một API cho các design token của bạn.";
...
Những quyết định thiết kế cấp thấp này thường được gọi là _design tokens_, và trong các dự án Tailwind, bạn lưu trữ các giá trị đó trong _biến theme_.
...
Tìm hiểu thêm về cách các biến theme ánh xạ tới các lớp tiện ích khác nhau trong tài liệu [không gian tên biến theme](#theme-variable-namespaces).

#### Tại sao lại là `@theme` thay vì `:root`?

Biến theme không _chỉ_ là các biến CSS — chúng cũng hướng dẫn Tailwind tạo ra các lớp tiện ích mới mà bạn có thể sử dụng trong HTML của mình.
...
Một số lớp tiện ích trong Tailwind như `flex` và `object-cover` là tĩnh, và luôn giống nhau từ dự án này sang dự án khác. Nhưng nhiều lớp khác được điều khiển bởi các biến theme, và chỉ tồn tại vì các biến theme bạn đã xác định.
...
Tìm hiểu thêm về cách các biến theme ánh xạ tới các lớp tiện ích và biến thể khác nhau trong tài liệu [không gian tên biến theme](#theme-variable-namespaces).

### Không gian tên biến theme

Các biến theme được xác định trong _không gian tên_ và mỗi không gian tên tương ứng với một hoặc nhiều API lớp tiện ích hoặc biến thể.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Các tiện ích màu sắc như <code>bg-red-500</code>, <code>text-sky-300</code>, và nhiều hơn nữa
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích font family như <code>font-sans</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích kích thước font chữ như <code>text-xl</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích độ đậm font chữ như <code>font-bold</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích khoảng cách chữ cái như <code>tracking-wide</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích chiều cao dòng như <code>leading-tight</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các biến thể điểm ngắt phản hồi như <code>sm:*</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các biến thể truy vấn container như <code>@sm:*</code> và các tiện ích kích thước như <code>max-w-md</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích khoảng cách và kích thước như <code>px-4</code>, <code>max-h-16</code>, và nhiều hơn nữa
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích bán kính viền như <code>rounded-sm</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích box shadow như <code>shadow-md</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích inset box shadow như <code>inset-shadow-xs</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích bộ lọc drop shadow như <code>drop-shadow-md</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích bộ lọc mờ như <code>blur-md</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích phối cảnh như <code>perspective-near</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích tỷ lệ khung hình như <code>aspect-video</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích hàm thời gian chuyển tiếp như <code>ease-out</code>
      </td>
    </tr>
    <tr>
      <td className="whitespace-nowrap">
      ...
      <td>
        Các tiện ích hoạt ảnh như <code>animate-spin</code>
      </td>
    </tr>
  </tbody>
</table>
...
Để có danh sách tất cả các biến theme mặc định, xem [tham chiếu biến theme mặc định](#default-theme-variable-reference).
...
Khi bạn làm điều này, tất cả các tiện ích mặc định sử dụng không gian tên đó _(như `bg-red-500`)_ sẽ bị xóa, và chỉ các giá trị tùy chỉnh của bạn _(như `bg-midnight`)_ sẽ có sẵn.
...
Bây giờ không có lớp tiện ích mặc định nào được điều khiển bởi các biến theme sẽ có sẵn, và bạn sẽ chỉ có thể sử dụng các lớp tiện ích khớp với các biến theme tùy chỉnh của bạn như `font-body` và `text-dusk`.
...
Sử dụng tùy chọn `inline`, lớp tiện ích sẽ sử dụng _giá trị_ biến theme thay vì tham chiếu biến theme thực tế:
...
Điều này xảy ra vì `var(--font-sans)` được giải quyết ở nơi `--font-sans` được xác định _(trên `#parent`)_, và `--font-inter` không có giá trị ở đó vì nó không được xác định cho đến khi sâu hơn trong cây _(trên `#child`)_.
