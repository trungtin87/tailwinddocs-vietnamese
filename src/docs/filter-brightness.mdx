...
export const description = "Các tiện ích để áp dụng bộ lọc brightness cho một phần tử.";
...
Sử dụng các tiện ích như `brightness-50` và `brightness-100` để kiểm soát độ sáng của một phần tử:
