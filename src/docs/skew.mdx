...
export const description = "Các tiện ích để nghiêng các phần tử bằng transform.";
...
Sử dụng các tiện ích `skew-<number>` như `skew-4` và `skew-10` để nghiêng một phần tử trên cả hai trục:
...
Sử dụng các tiện ích `skew-x-<number>` như `skew-x-4` và `-skew-x-10` để nghiêng một phần tử trên trục x:
...
Sử dụng các tiện ích `skew-y-<number>` như `skew-y-4` và `-skew-y-10` để nghiêng một phần tử trên trục y:
