...
export const description = "Các tiện ích để dịch chuyển các phần tử.";
...
Sử dụng các tiện ích `translate-<number>` như `translate-2` và `-translate-4` để dịch chuyển một phần tử trên cả hai trục dựa trên thang đo khoảng cách:
...
Sử dụng các tiện ích `translate-<fraction>` như `translate-1/4` và `-translate-full` để dịch chuyển một phần tử trên cả hai trục theo tỷ lệ phần trăm kích thước của phần tử:
...
Sử dụng các tiện ích `translate-x-<number>` hoặc `translate-x-<fraction>` như `translate-x-4` và `translate-x-1/4` để dịch chuyển một phần tử trên trục x:
...
Sử dụng các tiện ích `translate-y-<number>` hoặc `translate-y-<fraction>` như `translate-y-6` và `translate-y-1/3` để dịch chuyển một phần tử trên trục y:
...
Sử dụng các tiện ích `translate-z-<number>` như `translate-z-6` và `-translate-z-12` để dịch chuyển một phần tử trên trục z:
