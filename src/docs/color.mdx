...
export const description = "Các tiện ích để kiểm soát màu văn bản của một phần tử.";
...
Sử dụng các tiện ích như `text-blue-600` và `text-sky-400` để kiểm soát màu văn bản của một phần tử:
...
Sử dụng modifier độ mờ màu để kiểm soát độ mờ màu văn bản của một phần tử:
