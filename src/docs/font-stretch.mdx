...
export const description = "Các utility để kiểm soát độ kéo giãn font của một phần tử.";
...
Sử dụng các utility như `font-stretch-condensed` và `font-stretch-expanded` để thiết lập độ kéo giãn font của một phần tử:
...
Sử dụng các utility `font-stretch-<percentage>` như `font-stretch-50%` và `font-stretch-125%` để thiết lập độ kéo giãn font của một phần tử thành một phần trăm cụ thể:
