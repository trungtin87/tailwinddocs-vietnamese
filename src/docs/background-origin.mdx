...
export const description =
  "Các utility để kiểm soát cách nền của một phần tử được định vị tương đối với border, padding và nội dung.";
...
Sử dụng các utility `bg-origin-border`, `bg-origin-padding`, và `bg-origin-content` để kiểm soát nơi nền của một phần tử được render:
