...
export const description =
  "Các tiện ích để kiểm soát cách mask image của một phần tử được định vị tương đối với border, padding và content.";
...
Sử dụng các tiện ích như `mask-origin-border`, `mask-origin-padding`, và `mask-origin-content` để kiểm soát vị trí render mask của một phần tử:
