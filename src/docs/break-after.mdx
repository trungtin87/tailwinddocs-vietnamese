...
export const description = "Các utility để kiểm soát cách ngắt cột hoặc trang sau một phần tử.";
...
Sử dụng các utility như `break-after-column` và `break-after-page` để kiểm soát cách ngắt cột hoặc trang sau một phần tử:
