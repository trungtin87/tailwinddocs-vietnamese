...
export const description = "Các tiện ích để cắt bớt văn bản đến một số dòng cụ thể.";
...
Sử dụng các tiện ích `line-clamp-<number>` như `line-clamp-2` và `line-clamp-3` để cắt bớt văn bản nhiều dòng sau một số dòng cụ thể:
...
Sử dụng `line-clamp-none` để hoàn tác một tiện ích cắt dòng đã áp dụng trước đó:
