...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop hue-rotate cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-hue-rotate-90` và `backdrop-hue-rotate-180` để xoay màu (hue) của backdrop của một phần tử:
...
Sử dụng các tiện ích như `-backdrop-hue-rotate-90` và `-backdrop-hue-rotate-180` để đặt giá trị xoay màu backdrop âm:
