...
export const description = "Các tiện ích để kiểm soát bóng của một phần tử văn bản.";
...
Sử dụng các tiện ích như `text-shadow-sm` và `shadow-lg` để áp dụng các kích thước bóng văn bản khác nhau cho một phần tử văn bản:
...
Sử dụng các tiện ích như `text-shadow-indigo-500` và `text-shadow-cyan-500/50` để thay đổi màu của bóng văn bản:
