...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop sepia cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-sepia` và `backdrop-sepia-50` để kiểm soát hiệu ứng sepia được áp dụng cho backdrop của một phần tử:
