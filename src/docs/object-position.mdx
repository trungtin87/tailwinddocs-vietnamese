...
export const description =
  "Các tiện ích để kiểm soát cách nội dung của một phần tử được thay thế (replaced element) nên được định vị trong container của nó.";
...
Sử dụng các tiện ích như `object-left` và `object-bottom-right` để chỉ định cách nội dung của một phần tử được thay thế nên được định vị trong container của nó:

<Figure hint="Di chuột qua các ví dụ để xem hình ảnh đầy đủ">
