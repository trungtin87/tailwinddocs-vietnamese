...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop invert cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-invert` và `backdrop-invert-65` để kiểm soát việc đảo ngược màu của backdrop của một phần tử:
