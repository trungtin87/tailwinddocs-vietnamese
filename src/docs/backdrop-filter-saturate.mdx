...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop saturation cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-saturate-50` và `backdrop-saturate-100` để kiểm soát độ bão hòa của backdrop của một phần tử:
