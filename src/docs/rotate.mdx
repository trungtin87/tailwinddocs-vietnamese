...
export const description = "Các tiện ích để xoay các phần tử.";
...
Sử dụng các tiện ích `rotate-<number>` như `rotate-45` và `rotate-90` để xoay một phần tử theo độ:
...
Sử dụng các tiện ích `-rotate-<number>` như `-rotate-45` và `-rotate-90` để xoay một phần tử ngược chiều kim đồng hồ theo độ:
...
Sử dụng các tiện ích `rotate-x-<number>`, `rotate-y-<number>`, và `rotate-z-<number>` như `rotate-x-50`, `-rotate-y-30`, và `rotate-z-45` cùng nhau để xoay một phần tử trong không gian 3D:
