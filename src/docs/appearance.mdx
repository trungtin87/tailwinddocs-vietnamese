...
export const description = "Các tiện ích để loại bỏ styling mặc định của form control.";
...
Sử dụng `appearance-none` để reset bất kỳ styling đặc thù của trình duyệt nào trên một phần tử:
    ...
    <div className="mx-auto max-w-sm items-center">
      <div className="my-6 flex">
        ...
        <div className="mx-6 text-sm font-semibold text-gray-900 dark:text-gray-200">
          Áp dụng style mặc định của trình duyệt
        </div>
      </div>
      <div className="my-6 flex items-center">
        ...
        <div className="mx-6 text-sm font-semibold text-gray-900 dark:text-gray-200">Loại bỏ style mặc định của trình duyệt</div>
      </div>
    </div>
  }
</Example>
...
Tiện ích này thường được sử dụng khi tạo các component form tùy chỉnh.

### Khôi phục appearance mặc định

Sử dụng `appearance-auto` để khôi phục styling đặc thù của trình duyệt trên một phần tử:

<Figure hint="Thử mô phỏng `forced-colors: active` trong developer tools để thấy sự khác biệt">
    ...
    <div className="mx-auto my-6 grid max-w-sm items-center justify-center gap-8">
      ...
      <div className="flex items-center">
        ...
        >
          ...
          Giữ nguyên appearance tùy chỉnh
        </label>
      </div>
    </div>
  }
...
Điều này hữu ích để quay về các control chuẩn của trình duyệt trong một số chế độ accessibility nhất định.
