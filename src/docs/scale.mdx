...
export const description = "Các tiện ích để thu phóng các phần tử.";
...
Sử dụng các tiện ích `scale-<number>` như `scale-75` và `scale-150` để thu phóng một phần tử theo tỷ lệ phần trăm kích thước ban đầu của nó:
...
Sử dụng các tiện ích `scale-x-<number>` như `scale-x-75` và `-scale-x-150` để thu phóng một phần tử trên trục x theo tỷ lệ phần trăm chiều rộng ban đầu của nó:
...
Sử dụng các tiện ích `scale-y-<number>` như `scale-y-75` và `scale-y-150` để thu phóng một phần tử trên trục y theo tỷ lệ phần trăm chiều cao ban đầu của nó:
...
Sử dụng các tiện ích `-scale-<number>`, `-scale-x-<number>` hoặc `-scale-y-<number>` như `-scale-x-75` và `-scale-125` để lật và thu nhỏ một phần tử theo tỷ lệ phần trăm kích thước ban đầu của nó:
