...
export const description = "Các tiện ích để kiểm soát mức độ nghiêm ngặt của các điểm snap trong một snap container.";
...
Để scroll snapping hoạt động, bạn cũng cần thiết lập [căn chỉnh scroll snap](/docs/scroll-snap-align) trên các phần tử con.
