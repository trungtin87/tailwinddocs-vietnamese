...
export const description = "Các tiện ích để áp dụng bộ lọc backdrop grayscale cho một phần tử.";
...
Sử dụng các tiện ích như `backdrop-grayscale-50` và `backdrop-grayscale` để kiểm soát hiệu ứng grayscale được áp dụng cho backdrop của một phần tử:
