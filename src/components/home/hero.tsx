    ...
    <div>
      ...
      <GridContainer>
        <p className="max-w-(--breakpoint-md) px-2 text-lg/7 font-medium text-gray-600 max-sm:px-4 dark:text-gray-400">
          Một framework CSS ưu tiên tiện ích (utility-first) với các class như{" "}
          ...
          <span className="font-mono text-[1.0625rem] text-sky-500 dark:text-sky-400">text-center</span> và{" "}
          <span className="font-mono text-[1.0625rem] text-sky-500 dark:text-sky-400">rotate-90</span> có thể được
          kết hợp để xây dựng bất kỳ thiết kế nào, trực tiếp trong markup của bạn.
        </p>
      </GridContainer>
